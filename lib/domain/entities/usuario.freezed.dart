...
class _$UsuarioImpl implements _Usuario {
  ...
  @override
  String toString() {
    return 'Usuario(id: $id, username: $username, passwordHash: $passwordHash, nombre: $nombre, rol: $rol)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, username, passwordHash, nombre, rol);
...
abstract class _Usuario implements Usuario {
  const factory _Usuario(
      ...
      final UsuarioRol rol}) = _$UsuarioImpl;
